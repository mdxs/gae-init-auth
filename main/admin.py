...
class ConfigUpdateForm(wtf.Form):
  ...
  reddit_client_id = wtf.TextField('Reddit Key', filters=[util.strip_filter])
  reddit_client_secret = wtf.TextField('Reddit Secret', filters=[util.strip_filter])
  stackoverflow_client_id = wtf.TextField('Stack Overflow Client Id', filters=[util.strip_filter])
  stackoverflow_client_secret = wtf.TextField('Stack Overflow Client Secret', filters=[util.strip_filter])
  stackoverflow_key = wtf.TextField('Stack Overflow Key', filters=[util.strip_filter])
